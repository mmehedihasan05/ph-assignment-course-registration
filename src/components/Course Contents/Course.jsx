...
const Course = ({ course }) => {
    ...
    return (
        <div className="card bg-base-100 space-y-4 p-4 flex flex-col">
            <figure>
                <img
                    className="rounded-t-lg rounded-b-xl object-cover h-32 w-full"
                    src={cover}
                    alt={title}
                />
            </figure>
            <div className="card-body p-0 space-y-2 mx-auto">
                <h2 className="card-title h-16 items-start text-lg font-semibold text-[#1C1B1B]">
                    {title}
                </h2>
                <p className=" text-[#1C1B1B99] font-normal text-[15px]">{description}</p>

                <div className=" flex justify-between font-medium text-[#1C1B1B99] text-[15px]">
                    {/* Price */}
                ...
                btn bg-[#2F80ED] hover:hover:bg-[#2f66ed] text-white text-lg"
                >
                    Select
                </button>
            </div>
